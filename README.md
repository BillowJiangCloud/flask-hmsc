...
# 插入数据(密码123456)
insert into `user` (`uid`,`nickname`,`mobile`,`email`,`sex`,`avatar`,`login_name`,`login_pwd`,`login_salt`,`status`,`updated_time`,`created_time`) values (1,'BruceNick','12345678945','Bruce@aliyun.com',1,'','admin','816440c40b7a9d55ff9eb7b20760862c','cF3JfH5FJfQ8B2Ba',1,'2020-04-23 11:30:30','2020-04-23 11:10:30');
```

**2.创建stat_daily_site表**
...
flask-sqlacodegen 'mysql://root:password@127.0.0.1/hmsc_db' --tables goods --outfile "common/models/goods/Goods.py" --flask
```
